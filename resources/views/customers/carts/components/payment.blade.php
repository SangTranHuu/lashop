                    ...
                    <ul class="form-list">
                        ...
                        <li>
                            ...
                            <div class="input-box {{ $errors->has('name') ? ' has-error' : '' }}">
                                <input type="text" name="name" id="postcode" class="input-text validate-postcode" required="required" value="{{ old('name') }}">
                            </div>
                            ...
                            <div class="input-box" {{ $errors->has('phone') ? ' has-error' : '' }}>
                                <input type="text" name="phone" class="input-text validate-postcode" required="required" value="{{ old('phone') }}">
                            </div>
                        ...
                        <li>
                            ...
                            <div class="input-box {{ $errors->has('email') ? ' has-error' : '' }}">
                                <input type="email" name="email" class="input-text validate-postcode" required="required" value="{{ old('email') }}">
